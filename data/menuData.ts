...
export const menuItems: MenuItem[] = [
  {
    ...
    description: 'チーズインハンバーグ120g、目玉焼き入人参30g、ブロッコリー25g、他野菜、鶏肉のハーブ焼き、じゃがいもと玉ねぎのグラタン風えび添え、小松菜・ベーコン・コーンソテー。約950kcal、タンパク質65.7gの栄養満点メニュー。',
    features: [
      'タンパク質65.7g',
      'カロリー950kcal',
      '脂質23.0g',
    ...
    ingredients: [
      ...
      'ブロッコリー25g',
      '他野菜デミソースコンソメ',
      '鶏むね肉120g（オリーブオイル塩こしょうハーブ　スパゲッティ10g）',
      'じゃが芋100g 玉ねぎ50g えび12g ホワイトソース22g コンソメ0.5g 牛乳10g',
      '小松菜50g ベーコン20g コーン15g 塩こしょう油'
    ],
    allergens: [
      '小麦',
      '卵',
  ...
  },
  {
    ...
    name: '麻婆豆腐・酢鶏・豆腐入り鶏しゅうまい野菜あんかけ・炒りタマゴ中華風',
    calories: 818,
    protein: 72.5,
    fat: 13.0,
    carbs: 0,
  ...
  },
  {
    ...
    name: '豚肉生姜焼き・鶏肉の竜田揚げ・スクランブルエッグ＆ほうれん草ホワイトソース・ナポリタンチーズかけ',
    calories: 976,
    protein: 73.5,
    fat: 25.0,
    carbs: 0,
