...
export function MenuDetailModal({ item, isOpen, onClose }: MenuDetailModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[99999] flex items-center justify-center px-4 py-20 sm:p-6 overflow-hidden"
      onClick={onClose}
    >
      {/* オーバーレイ */}
      ...
      {/* モーダルコンテンツ */}
      <div
        className="relative bg-white rounded-xl w-full max-w-2xl max-h-[calc(100vh-10rem)] sm:max-h-[calc(100vh-3rem)] shadow-2xl flex flex-col overflow-hidden"
