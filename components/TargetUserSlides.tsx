        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="space-y-2 mb-4">
            <div className="flex items-center">
              ...
              <span className="text-base text-gray-700">プロテイン不要</span>
            </div>
            <div className="flex items-center">
              <svg className="w-5 h-5 text-orange-600 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-base text-gray-700">美味しく摂取</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 flex flex-col justify-start">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="bg-orange-50 rounded-lg p-3 text-center">
              <div className="text-3xl font-bold text-orange-600">1,400+</div>
              <div className="text-sm text-gray-600">kcal/食</div>
            </div>
            <div className="bg-orange-50 rounded-lg p-3 text-center">
              <div className="text-3xl font-bold text-orange-600">70g+</div>
