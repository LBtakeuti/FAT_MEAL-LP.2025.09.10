...
export default function DailyScenesSection() {
  // F62/F73: スクロールで見出し・3カードをフェードイン。共通部品 <Reveal> に委譲
  // （IOロジック・reduced-motion・PE安全は Reveal 側で一元管理）。
  return (
    <section className="bg-white py-8 sm:py-10" aria-label="ふとるめしのある毎日">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <Reveal className="relative mb-8 sm:mb-12 pt-8 sm:pt-12 text-center">
