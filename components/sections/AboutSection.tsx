...
const AboutSection: React.FC = () => {
  ...
  const features = [
    {
      title: '圧倒的なボリューム',
      description: '**1食でしっかり満足のボリューム！**/しっかりとした味付けで白米が進む。/体づくりに必要なカロリーを手軽に摂取！',
      number: '01',
    },
    {
      title: '5分で完成！',
      description: 'たくさん食べて欲しいけど、作る時間もおかずのバリエーションもなくなってきた…/そんな悩みはふとるめしで解決！/レンジで5分温めて最高のお弁当が完成！',
      number: '02',
    },
    {
      title: '管理栄養士監修で栄養満点',
      description: '圧倒的なボリュームとご飯が進む味付けの、未だかつてない冷凍弁当！/毎日のカロリー管理もふとるめしで解決！',
      number: '03',
    },
  ];
