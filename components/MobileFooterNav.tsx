    ...
    <div 
      ...
      <div className="grid grid-cols-2 h-14">
        ...
        <button
          ...
          className="flex flex-col items-center justify-center text-white hover:bg-orange-700 transition-colors"
        >
          <svg 
        ...
        <button
          ...
          className="flex flex-col items-center justify-center text-white hover:bg-orange-700 transition-colors border-l border-orange-500"
        >
          <svg 
            className="w-5 h-5 mb-0.5" 
            fill="currentColor" 
