...
const FeaturesSectionMobile: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      title: '簡単に食べられる！',
      subtitle: '',
      description: '部活動や、ハードワーク、筋トレで大量のエネルギーを消費した後は「ふとるめし」が最適解。冷凍弁当では類を見ない「量」「圧倒的な味」がレンジ調理のみで実現！一に美味しく、二に楽に、が私たちのモットーです。',
    ...
    },
    {
      title: '圧倒的な「量」',
      subtitle: '',
      description: '1食あたり平均900kcalの大容量！一般的な宅配弁当の2倍以上のボリュームで、しっかりと満足感を得られます。量を食べるのが苦手な方でも、美味しさで自然と完食できます。',
