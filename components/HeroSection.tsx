...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="h-[100dvh] sm:min-h-screen flex items-center justify-center bg-orange-500 pt-4 sm:pt-16 pb-20 sm:pb-0 relative overflow-hidden">
      {/* お弁当画像 - 画面中央に配置 */}
      <div className="absolute inset-x-4 top-[70px] bottom-20 sm:bottom-4 md:inset-8 md:top-[80px] lg:inset-12 lg:top-[90px] z-0">
        <Image
      ...
      <div className="max-w-[375px] px-4 md:max-w-[768px] md:px-6 lg:max-w-[1200px] lg:px-8 mx-auto text-center animate-fadeIn relative z-10">
        <div className="mb-8 sm:mb-8">
          <h2 className="text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl font-bold text-white mb-4 sm:mb-4">
