        ...
        <div className="hidden sm:block space-y-16">
          ...
          <div>
            ...
            <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <p>
                スポーツを全力で頑張る学生にとって「体重を増やしたい！」と思う人は多い。特に小中学生などは体重がなかなか増えずに悩まれている選手もいる。<span className="font-semibold text-orange-600">「プロテインを飲んでいますが、体重がなかなか増えません…」</span>といった声があり、体重が増えないことは選手だけではなく親御さんにとっても大きな悩みになっている。
              </p>
              <p>
