...
const FAQSection: React.FC = () => {
  const faqs = [
    ...
    },
    {
      question: '賞味期限は？',
      answer:
        '冷凍保存で製造日から約10ヶ月です。解凍後は当日中にお召し上がりください。商品パッケージに記載の賞味期限をご確認ください。',
    },
    {
      question: '配送料は？',
      answer:
        '送料はお客様負担となっており、決済時画面で確認できます。離島や一部地域の場合ですと金額に変動がありますのでご確認ください。',
    },
    {
      question: 'アレルギー対応は？',
      answer:
        '各メニューにアレルギー情報を記載しております。商品ページで詳細をご確認いただけます。',
    },
  ];
