...
describe('inheritPreferredDateForBilling', () => {
  ...
  it('billingDate が UTC 14:59 (= JST 4/30 23:59) → 年月は 2026-04', () => {
    // 2026-04-30 14:59 UTC = JST 2026-04-30 23:59 → JST 年月は 2026-04
    const billing = new Date('2026-04-30T14:59:00Z');
    expect(inheritPreferredDateForBilling('2026-03-15', billing)).toBe('2026-04-15');
  });
