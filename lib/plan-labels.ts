 ...
 *   - sub-6                    → 「【定期】ふとるめしセット（6食）」（F31）
 *   - sub-12                   → 「【定期】ダブルふとるめセット（12食）」（F31）
 *   - subscription-monthly-12  → 「【定期】ふとるめし12食」（旧プランは旧表記のまま、既存契約者保護）
...
const PLAN_LABELS: Record<string, string> = {
  // 現役
  'trial-6': 'ふとるめし お試し6食セット',
  'sub-6': '【定期】ふとるめしセット（6食）',
  'sub-12': '【定期】ダブルふとるめセット（12食）',
  // 旧プラン体系（既存契約者の継続処理用、旧表記のまま据置）
