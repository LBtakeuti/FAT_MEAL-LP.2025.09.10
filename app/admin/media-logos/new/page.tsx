      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h1 className="text-2xl font-bold text-gray-900">メディアロゴ追加</h1>
            <button
              type="button"
          ...
          <form onSubmit={handleSubmit} className="px-6 py-4 space-y-6">
            ...
            <div>
              ...
              {formData.image_url && (
                <div className="mt-2 mb-3 p-3 bg-gray-50 rounded-lg inline-block">
                  <img src={formData.image_url} alt="プレビュー" className="h-16 w-auto object-contain" />
                </div>
              )}
              <div className="mt-1">
                <input
            ...
            <div>
              ...
              <input
                ...
                placeholder="例: 日本経済新聞"
                className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm"
              />
              <p className="mt-1 text-xs text-gray-400">alt属性に使用されます</p>
            </div>
