...
| プランID | プラン名 | 商品 | 送料 | 月額合計 | 1食(送料別) | 種別 |
|---|---|---:|---:|---:|---:|---|
| `trial-6` | お試しプラン | ¥4,200 | ¥1,500 | **¥5,700** | ¥700 | 一回購入 |
| `sub-6` | 6食プラン | ¥3,000 | ¥1,500 | **¥4,500** | ¥500 | 月額サブスク |
| `sub-12` | 12食プラン | ¥6,000 | ¥1,500 | **¥7,500** | ¥500 | 月額サブスク |

> ※ 1食あたり価格は**商品代のみ**（送料を含めない）。UIカードでは「¥500/食（税込・送料別）」と表記。
